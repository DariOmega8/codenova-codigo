...
CREATE TABLE IF NOT EXISTS `mydb`.`administrador` (
  ...
  PRIMARY KEY (`id administrador`, `usuario_id usuario`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`menu` (
  ...
  `administrador_usuario_id usuario` INT NOT NULL,
  PRIMARY KEY (`id menu`, `administrador_id administrador`, `administrador_usuario_id usuario`),
  INDEX `fk_menu_administrador1_idx` (`administrador_id administrador` ASC, `administrador_usuario_id usuario` ASC),
  CONSTRAINT `fk_menu_administrador1`
    FOREIGN KEY (`administrador_id administrador` , `administrador_usuario_id usuario`)
    REFERENCES `mydb`.`administrador` (`id administrador` , `usuario_id usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`administrador_has_stock` (
  ...
  CONSTRAINT `fk_administrador_has_stock_administrador1`
    FOREIGN KEY (`administrador_id administrador`)
    REFERENCES `mydb`.`administrador` (`id administrador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`mesa_has_pedido` (
  ...
  CONSTRAINT `fk_mesa_has_pedido_mesa1`
    FOREIGN KEY (`mesa_id mesa`)
    REFERENCES `mydb`.`mesa` (`id mesa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`cliente_has_mesa` (
  ...
  `cliente_usuario_id usuario` INT NOT NULL,
  `mesa_id mesa` INT NOT NULL,
  PRIMARY KEY (`cliente_id cliente`, `cliente_usuario_id usuario`, `mesa_id mesa`),
  INDEX `fk_cliente_has_mesa_mesa1_idx` (`mesa_id mesa` ASC),
  INDEX `fk_cliente_has_mesa_cliente1_idx` (`cliente_id cliente` ASC, `cliente_usuario_id usuario` ASC),
...
-- -----------------------------------------------------
-- Table `mydb`.`empleado_has_mesa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`empleado_has_mesa` (
  `empleado_id empleado` INT NOT NULL,
  `empleado_usuario_id usuario` INT NOT NULL,
  `mesa_id mesa` INT NOT NULL,
  PRIMARY KEY (`empleado_id empleado`, `empleado_usuario_id usuario`, `mesa_id mesa`),
  INDEX `fk_empleado_has_mesa_mesa1_idx` (`mesa_id mesa` ASC),
  INDEX `fk_empleado_has_mesa_empleado1_idx` (`empleado_id empleado` ASC, `empleado_usuario_id usuario` ASC),
  CONSTRAINT `fk_empleado_has_mesa_empleado1`
    FOREIGN KEY (`empleado_id empleado` , `empleado_usuario_id usuario`)
    REFERENCES `mydb`.`empleado` (`id empleado` , `usuario_id usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empleado_has_mesa_mesa1`
    FOREIGN KEY (`mesa_id mesa`)
    REFERENCES `mydb`.`mesa` (`id mesa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
